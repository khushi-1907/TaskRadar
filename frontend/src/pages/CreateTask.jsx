  ...
  return (
    <>
      <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#f9f0ff] to-[#e0f7fa] px-4 py-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 w-full max-w-2xl relative overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            {flash.message && (
              <div
                className={`mb-6 px-4 py-3 rounded-lg text-sm flex items-center ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-transparent transition"
            ...
            <div className="mt-8 text-center">
              <Link
                to="/tasks"
                className="text-purple-500 hover:text-purple-700 hover:underline font-medium text-sm md:text-base"
              >
                ← Back to Tasks
              </Link>
            </div>
